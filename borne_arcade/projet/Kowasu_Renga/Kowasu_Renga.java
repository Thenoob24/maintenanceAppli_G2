...
public class Kowasu_Renga {
	...
	public static void main(String[] args) {
		...
		int[][] info_bloc = new int[75][3]; // Information sur les blocs : l'état du bloc, le nombre de coups pour le
											// détruire et l'indice de la couleur utilisée //
		...
		Texte viesRestantes = new Texte(Couleur.BLANC, nbVies + " balles restantes", font,
				new Point(120, hauteur - 40));
		...
		nb = 0; // Correspond au nombre de fois que l'on touche un bloc, sert à augmenter
				// décider quand on augmente la vitesse //
		...
		while (nbVies >= 0) {
			...
			if (balle.getO().getY() <= 0) { // La balle est perdue, on reset les paramètres //
				...
				// Pour éviter que le rectangle de la raquette ne soit inversé (coin bas gauche
				// à droite du coin haut droite)
