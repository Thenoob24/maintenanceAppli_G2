...
public class BoiteSelection extends Boite {
	...
	public boolean selection(ClavierBorneArcade clavier) {
		...
		/*
		 * BACK:
		 * repasse au premier élément du tableau lorsque la valeur du pointeur est égale
		...
		/*
		 * BACK:
		 * repasse au dernier élément du tableau lorsque la valeur du pointeur est égale
		 * à 0
		 *
		 * FRONT:
